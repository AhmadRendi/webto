...
<!-- ===== KONTAK ===== -->
<section class="py-3 bg-light mt-5" id="kontak" style="min-height: 80vh; padding-top: 100px !important;">
    <div class="container py-5">
        <div class="row g-5">
            <!-- Info Kontak -->
            <div class="col-lg-5">
                <p class="text-primary fw-semibold text-uppercase" style="letter-spacing:2px; font-size:.85rem;">Hubungi Kami</p>
                <h2 class="fw-bold mb-3">Ada Pertanyaan?</h2>
                <p class="text-muted mb-4">
                    Isi formulir di bawah atau hubungi kami langsung. Tim kami akan merespon dalam 1x24 jam.
                </p>
                ...
                <div class="lp-form-card p-4 bg-white rounded shadow-sm">
                    ...
                    <form id="contact-form" action="https://webto.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8&orgId=00DdM00000vzVm1" method="POST" target="hidden_iframe" onsubmit="submitted=true;">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                <label class="form-label fw-medium" for="phone">Phone</label>
                                <input class="form-control" id="phone" maxlength="40" name="phone" size="20" type="text" />
                            </div>

                            <div class="col-12">
                                <label class="form-label fw-medium" for="company">Company</label>
                                <input class="form-control" id="company" maxlength="40" name="company" size="20" type="text" />
                            </div>

                            <div class="col-sm-6">
                                <label class="form-label fw-medium" for="industry">Industry</label>
                            ...
                            <div class="col-sm-6">
                                <label class="form-label fw-medium" for="state_code">State/Province</label>
                                <select class="form-select" id="state_code" name="state_code"><option value="">--None--</option><option value="AC">AC</option>
                            ...
                            <div class="col-sm-6">
                                <label class="form-label fw-medium" for="country_code">Country</label>
                                <select class="form-select" id="country_code" name="country_code"><option value="">--None--</option><option value="AF">AF</option>
